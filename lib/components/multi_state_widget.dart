...
class MultiStateWidget extends StatefulWidget {
  ...
  MultiStateState createState() => MultiStateState(controller,defaultState,defaultLoadingText,defaultEmptyText);
...
class MultiStateState extends State<MultiStateWidget>{
  ...
  MultiStateState(this.controller,this.state, this.defaultLoadingText, this.defaultEmptyText){
  ...
  Widget build(BuildContext context) {
    Widget loadingWidget = widget.loadingChild != null ? widget.loadingChild : Center(
      child: Wrap(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Text(defaultLoadingText, style: TextStyle(color: Color(0xFF666666), fontSize: 17), textAlign: TextAlign.center,),
          )
        ],
      ),
    );
    Widget errorWidget = widget.errorChild != null ?  widget.errorChild : Center(
      child: Wrap(
        direction: Axis.vertical,
        alignment: WrapAlignment.center,
        crossAxisAlignment: WrapCrossAlignment.center,
        children: <Widget>[
          Image.asset("assets/main/images/multi-state-error.png", width: 180, height: 150,),
          Container(
            margin: EdgeInsets.only(top: 15),
            width: MediaQuery.of(context).size.width * 0.8,
            child: Text(errorMsg, style: TextStyle(color: Color(0xFF666666), fontSize: 17), textAlign: TextAlign.center,),
          ),
          Container(
    ...
    Widget emptyWidget = widget.emptyChild != null ? widget.emptyChild : Center(
      child: Wrap(
        direction: Axis.vertical,
        alignment: WrapAlignment.center,
        crossAxisAlignment: WrapCrossAlignment.center,
        children: <Widget>[
          Image.asset("assets/main/images/multi-state-empty.png", width: 180, height: 150,),
          Container(
            margin: EdgeInsets.only(top: 15),
            width: MediaQuery.of(context).size.width * 0.8,
            child: Text(defaultEmptyText, style: TextStyle(color: Color(0xFF666666), fontSize: 17), textAlign: TextAlign.center,),
          ),
          Container(
            margin: EdgeInsets.only(top: 5),
            child: FlatButton(
    ...
    return Container(
      child: Stack(
        children: <Widget>[
          widget.child,
          state == MultiStateWidget.STATE_EMPTY ? Container(color: Colors.white, child: emptyWidget,) : Container(height: 0, width: 0,),
          state == MultiStateWidget.STATE_ERROR ? Container(color: Colors.white, child: errorWidget,) : Container(height: 0, width: 0,),
          state == MultiStateWidget.STATE_LOADING ? Container(color: Colors.white, child: loadingWidget,) : Container(height: 0, width: 0,),
        ],
      ),
    );
  }
