...
class operatorIndexPage extends StatefulWidget {
  @override
  _operatorIndexPageState createState() => new _operatorIndexPageState();
}

class _operatorIndexPageState extends State<operatorIndexPage> {
  dynamic data;
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
            ...
            title: Text('工作台',style: TextStyle(color: _currentIndex != 1 ? _defaultColor : _activeColor )),
          ),
          BottomNavigationBarItem(
            icon: Icon( Icons.settings,  color: _defaultColor),
            activeIcon: Icon( Icons.settings, color: _activeColor ),
            title: Text('设置', style: TextStyle(color: _currentIndex != 2 ? _defaultColor : _activeColor )),
          ),
        ],
      ),
    );
